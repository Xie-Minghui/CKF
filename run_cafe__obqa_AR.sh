...
for seed in 0; do
  python3 -u cafe.py --dataset $dataset \
      ...
      --n_epochs $n_epochs --max_epochs_before_stop 100  \
      ...
      --train_statements ${path_abs}/data/${dataset}/statement/train-fact.statement.jsonl \
      --dev_statements   ${path_abs}/data/${dataset}/statement/dev-fact.statement.jsonl \
      --test_statements  ${path_abs}/data/${dataset}/statement/test-fact.statement.jsonl \
