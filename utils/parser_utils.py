...
ENCODER_DEFAULT_LR = {
    ...
    'medqa_usmle': {
        'SapBERT-from-PubMedBERT-fulltext': 5e-5,
    },
}
...
EMB_PATHS = {
    'transe': '/your path/data/transe/glove.transe.sgd.ent.npy',
    'lm': '/your path/data/transe/glove.transe.sgd.ent.npy',
    'numberbatch': '/your path/data/transe/concept.nb.npy',
    'tzw': '/your path/data/cpnet/tzw.ent.npy',
    'ddb': '/your path/data/ddb/ent_emb.npy',
}
...
def add_encoder_arguments(parser):
    ...
    parser.add_argument('-elr', '--encoder_lr', default=1e-5, type=float, help='learning rate')
    args, _ = parser.parse_known_args()
